...
If we're interested in leaf lifespan, we see that this is called "Leaf lifespan (LLS)" in the database.  Now that we know the proper spelling, we can use the function `BIEN_trait_trait` to download all observations of that trait.

```{r}

LLS <- BIEN_trait_trait(trait = "Leaf lifespan (LLS)")
