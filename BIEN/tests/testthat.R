...
test_that("Plot functions return a dataframe",{
  ...
  expect_that(BIEN_plot_sampling_protocol(sampling_protocol = "test"),is_a("data.frame"))
...
test_that("Stem functions return a dataframe",{
  expect_that(BIEN_stem_species(species = "Abies amabilis") ,is_a("data.frame"))
})
...
test_that("Trait functions return a dataframe",{
  ...
  expect_that(BIEN_trait_mean(species = "Xanthium strumarium",trait = "Leaf dry matter content (LDMC)") ,is_a("data.frame"))
  expect_that(BIEN_trait_species("Xanthium strumrium") ,is_a("data.frame"))
  expect_that(BIEN_trait_trait("Leaf dry matter content (LDMC)") ,is_a("data.frame"))
  expect_that(BIEN_trait_traitbyfamily(trait = "Leaf dry matter content (LDMC)",family = "Asteraceae") ,is_a("data.frame"))
  expect_that(BIEN_trait_traitbygenus(trait = "Leaf dry matter content (LDMC)",genus = "Xanthium") ,is_a("data.frame"))
  expect_that(BIEN_trait_traitbyspecies(trait = "Leaf dry matter content (LDMC)",species = "Xanthium strumarium") ,is_a("data.frame"))
